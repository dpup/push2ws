...
// Package push2ws contains a web server which will act as a PubsubHubBub to
...
// TODO(dan): Store history and optionally send to new clients.

// Bridge broadcasts messages received via PuSH to Web Socket clients.
type Bridge struct {
...
// NewBridge creates a new PubSubHubbub to Web Socket bridge.
func NewBridge(allowCrossOrigin bool) *Bridge {
	return &Bridge{
...
// watchSignals handles various signals and gracefully shuts down the bridge by
// disconnecting clients and unsubscribing from the hub.
